...
public class NodeHelper
{
	public static TableNode parseTableNode(INodeType nodeType)
	{
		...
		if(sqlColumnPrimaryKey != null)
		{
			...
			tableNode.primaryKeyDefaultValueExpressionDriver = sqlColumnPrimaryKey.defaultValueExpressionDriver();
			...
			tableNode.primaryKeyNode2JDBC  = sqlColumnPrimaryKey.nodeValue2JDBC();
			tableNode.primaryKeyJDBC2Node  = sqlColumnPrimaryKey.JDBC2NodeValue();
	...
	public class TableNode
	{
		...
		private Class<? extends IDefaultValueExpressionDriver> primaryKeyDefaultValueExpressionDriver = null;
		...
		private Class<? extends Function<?,?>> primaryKeyNode2JDBC  = null;
		private Class<? extends Function<?,?>> primaryKeyJDBC2Node  = null;
		...
		protected Class<? extends IDefaultValueExpressionDriver> getPrimaryKeyDefaultValueExpressionDriver()
		{
			return primaryKeyDefaultValueExpressionDriver;
		}
		...
		protected Class<? extends Function<?, ?>> getPrimaryKeyNode2JDBC()
		{
			return primaryKeyNode2JDBC;
		}
		protected Class<? extends Function<?, ?>> getPrimaryKeyJDBC2Node()
		{
